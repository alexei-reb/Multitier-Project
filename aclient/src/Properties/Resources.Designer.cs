...
namespace DesktopClient.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to JPEG Image (*.jpg)|*.jpg|GIF Image (*.gif)|*.gif|BMP Image (*.bmp)|*.bmp|TIFF Image (*.tif, *.tiff)|*.tif*;*.tiff|PNG Image (*.png)|*.png|PSD Image (*.psd)|*.psd.
        /// </summary>
